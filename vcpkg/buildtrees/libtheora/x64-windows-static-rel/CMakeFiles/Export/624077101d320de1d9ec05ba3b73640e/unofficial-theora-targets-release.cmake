...
set_target_properties(unofficial::theora::theora PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/theora.lib"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theora )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theora "${_IMPORT_PREFIX}/lib/theora.lib" )
...
set_target_properties(unofficial::theora::theoraenc PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/theoraenc.lib"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theoraenc )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theoraenc "${_IMPORT_PREFIX}/lib/theoraenc.lib" )
...
set_target_properties(unofficial::theora::theoradec PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "C"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/lib/theoradec.lib"
  )

list(APPEND _cmake_import_check_targets unofficial::theora::theoradec )
list(APPEND _cmake_import_check_files_for_unofficial::theora::theoradec "${_IMPORT_PREFIX}/lib/theoradec.lib" )
